...
namespace Forem
{
    ...
    {
        partial void PrepareGetHealthChecksDatabaseArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? healthCheckToken);
        partial void PrepareGetHealthChecksDatabaseRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? healthCheckToken);
        partial void ProcessGetHealthChecksDatabaseResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task GetHealthChecksDatabaseAsync(
            string? healthCheckToken = default,
            global::Forem.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await GetHealthChecksDatabaseAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Forem.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Forem.AutoSDKHttpResponse> GetHealthChecksDatabaseAsResponseAsync(
            string? healthCheckToken = default,
            global::Forem.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetHealthChecksDatabaseArguments(
                httpClient: HttpClient,
                healthCheckToken: ref healthCheckToken);
            ...
            if (healthCheckToken != default)
            {
                __httpRequest.Headers.TryAddWithoutValidation("health-check-token", healthCheckToken.ToString());
            }
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetHealthChecksDatabaseRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Forem.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Forem.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getHealthChecksDatabase",
                                methodName: "GetHealthChecksDatabaseAsync",
                                pathTemplate: "\"/api/health_checks/database\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetHealthChecksDatabaseResponse(
                    httpClient: HttpClient,
