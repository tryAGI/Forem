...
namespace Forem
{
    public partial class BadgeAchievementsClient
    {
        ...
        private static readonly global::Forem.EndPointSecurityRequirement s_CreateBadgeAchievementsSecurityRequirement0 =
        ...
        private static readonly global::Forem.EndPointSecurityRequirement[] s_CreateBadgeAchievementsSecurityRequirements =
            new global::Forem.EndPointSecurityRequirement[]
            {                s_CreateBadgeAchievementsSecurityRequirement0,
            };
        partial void PrepareCreateBadgeAchievementsArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Forem.CreateBadgeAchievementsRequest request);
        partial void PrepareCreateBadgeAchievementsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Forem.CreateBadgeAchievementsRequest request);
        partial void ProcessCreateBadgeAchievementsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateBadgeAchievementsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Forem.BadgeAchievement> CreateBadgeAchievementsAsync(

            global::Forem.CreateBadgeAchievementsRequest request,
            global::Forem.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateBadgeAchievementsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Forem.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Forem.AutoSDKHttpResponse<global::Forem.BadgeAchievement>> CreateBadgeAchievementsAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateBadgeAchievementsArguments(
            ...
            var __authorizations = global::Forem.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateBadgeAchievementsSecurityRequirements,
                operationName: "CreateBadgeAchievementsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateBadgeAchievementsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Forem.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Forem.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createBadgeAchievements",
                                methodName: "CreateBadgeAchievementsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateBadgeAchievementsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Forem.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateBadgeAchievementsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Forem.BadgeAchievement.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Forem.AutoSDKHttpResponse<global::Forem.BadgeAchievement>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Forem.BadgeAchievement.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Forem.BadgeAchievement> CreateBadgeAchievementsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Forem.CreateBadgeAchievementsRequest
            {
                BadgeAchievement = badgeAchievement,
            };

            return await CreateBadgeAchievementsAsync(
                request: __request,
                requestOptions: requestOptions,
