...
namespace Forem
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Forem.EndPointSecurityRequirement s_DeleteAdminUsersByUserIdIdentitiesByIdSecurityRequirement0 =
        ...
        private static readonly global::Forem.EndPointSecurityRequirement[] s_DeleteAdminUsersByUserIdIdentitiesByIdSecurityRequirements =
            new global::Forem.EndPointSecurityRequirement[]
            {                s_DeleteAdminUsersByUserIdIdentitiesByIdSecurityRequirement0,
            };
        partial void PrepareDeleteAdminUsersByUserIdIdentitiesByIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int userId,
            ref int id);
        partial void PrepareDeleteAdminUsersByUserIdIdentitiesByIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int userId,
            int id);
        partial void ProcessDeleteAdminUsersByUserIdIdentitiesByIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        /// <summary>
        /// Unlink an identity from a user (Admin)<br/>
        ...
        public async global::System.Threading.Tasks.Task DeleteAdminUsersByUserIdIdentitiesByIdAsync(
            int userId,
            int id,
            global::Forem.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await DeleteAdminUsersByUserIdIdentitiesByIdAsResponseAsync(
                userId: userId,
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Forem.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Forem.AutoSDKHttpResponse> DeleteAdminUsersByUserIdIdentitiesByIdAsResponseAsync(
            int userId,
            int id,
            global::Forem.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteAdminUsersByUserIdIdentitiesByIdArguments(
            ...
            var __authorizations = global::Forem.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteAdminUsersByUserIdIdentitiesByIdSecurityRequirements,
                operationName: "DeleteAdminUsersByUserIdIdentitiesByIdAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteAdminUsersByUserIdIdentitiesByIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Forem.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Forem.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "deleteAdminUsersByUserIdIdentitiesById",
                                methodName: "DeleteAdminUsersByUserIdIdentitiesByIdAsync",
                                pathTemplate: "$\"/api/admin/users/{userId}/identities/{id}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteAdminUsersByUserIdIdentitiesByIdResponse(
                    httpClient: HttpClient,
