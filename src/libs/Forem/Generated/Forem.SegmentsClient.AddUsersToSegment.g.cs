...
namespace Forem
{
    public partial class SegmentsClient
    {
        ...
        private static readonly global::Forem.EndPointSecurityRequirement s_AddUsersToSegmentSecurityRequirement0 =
        ...
        private static readonly global::Forem.EndPointSecurityRequirement[] s_AddUsersToSegmentSecurityRequirements =
            new global::Forem.EndPointSecurityRequirement[]
            {                s_AddUsersToSegmentSecurityRequirement0,
            };
        partial void PrepareAddUsersToSegmentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int id,
            global::Forem.SegmentUserIds request);
        partial void PrepareAddUsersToSegmentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int id,
            global::Forem.SegmentUserIds request);
        partial void ProcessAddUsersToSegmentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        /// <summary>
        /// Add users to a manually managed audience segment<br/>
        /// Add users in bulk to the specified manual audience segment.<br/>
        ...
        public async global::System.Threading.Tasks.Task AddUsersToSegmentAsync(
            int id,
        ...
        {
            await AddUsersToSegmentAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Forem.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Forem.AutoSDKHttpResponse> AddUsersToSegmentAsResponseAsync(
            int id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAddUsersToSegmentArguments(
            ...
            var __authorizations = global::Forem.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AddUsersToSegmentSecurityRequirements,
                operationName: "AddUsersToSegmentAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAddUsersToSegmentRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Forem.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Forem.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "AddUsersToSegmentAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAddUsersToSegmentResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task AddUsersToSegmentAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Forem.SegmentUserIds
            {
                UserIds = userIds,
            };

            await AddUsersToSegmentAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
