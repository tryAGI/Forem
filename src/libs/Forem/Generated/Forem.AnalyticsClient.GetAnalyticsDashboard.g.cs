...
namespace Forem
{
    public partial class AnalyticsClient
    {
        ...
        private static readonly global::Forem.EndPointSecurityRequirement s_GetAnalyticsDashboardSecurityRequirement0 =
        ...
        private static readonly global::Forem.EndPointSecurityRequirement[] s_GetAnalyticsDashboardSecurityRequirements =
            new global::Forem.EndPointSecurityRequirement[]
            {                s_GetAnalyticsDashboardSecurityRequirement0,
            };
        partial void PrepareGetAnalyticsDashboardArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? start,
            ref string? end,
            ref int? articleId,
            ref int? organizationId);
        partial void PrepareGetAnalyticsDashboardRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? articleId,
            int? organizationId);
        partial void ProcessGetAnalyticsDashboardResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task GetAnalyticsDashboardAsync(
        ...
        {
            await GetAnalyticsDashboardAsResponseAsync(
                start: start,
                end: end,
                articleId: articleId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Forem.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Forem.AutoSDKHttpResponse> GetAnalyticsDashboardAsResponseAsync(
            string? start = default,
            string? end = default,
            int? articleId = default,
            int? organizationId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAnalyticsDashboardArguments(
            ...
            var __authorizations = global::Forem.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAnalyticsDashboardSecurityRequirements,
                operationName: "GetAnalyticsDashboardAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetAnalyticsDashboardRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Forem.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Forem.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetAnalyticsDashboardAsync",
                                pathTemplate: "\"/api/analytics/dashboard\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAnalyticsDashboardResponse(
                    httpClient: HttpClient,
