...
namespace Forem
{
    public partial class AnalyticsClient
    {
        ...
        private static readonly global::Forem.EndPointSecurityRequirement s_GetAnalyticsHistoricalSecurityRequirement0 =
        ...
        private static readonly global::Forem.EndPointSecurityRequirement[] s_GetAnalyticsHistoricalSecurityRequirements =
            new global::Forem.EndPointSecurityRequirement[]
            {                s_GetAnalyticsHistoricalSecurityRequirement0,
            };
        partial void PrepareGetAnalyticsHistoricalArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string start,
            ref string? end,
            ref int? articleId,
            ref int? organizationId);
        partial void PrepareGetAnalyticsHistoricalRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? articleId,
            int? organizationId);
        partial void ProcessGetAnalyticsHistoricalResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task GetAnalyticsHistoricalAsync(
            string start,
            string? end = default,
        ...
        {
            await GetAnalyticsHistoricalAsResponseAsync(
                start: start,
                end: end,
                articleId: articleId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Forem.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Forem.AutoSDKHttpResponse> GetAnalyticsHistoricalAsResponseAsync(
            string start,
            string? end = default,
            int? articleId = default,
            int? organizationId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAnalyticsHistoricalArguments(
            ...
            var __authorizations = global::Forem.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAnalyticsHistoricalSecurityRequirements,
                operationName: "GetAnalyticsHistoricalAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetAnalyticsHistoricalRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Forem.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Forem.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getAnalyticsHistorical",
                                methodName: "GetAnalyticsHistoricalAsync",
                                pathTemplate: "\"/api/analytics/historical\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAnalyticsHistoricalResponse(
                    httpClient: HttpClient,
