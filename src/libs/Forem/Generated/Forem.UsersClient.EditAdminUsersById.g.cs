...
namespace Forem
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Forem.EndPointSecurityRequirement s_EditAdminUsersByIdSecurityRequirement0 =
        ...
        private static readonly global::Forem.EndPointSecurityRequirement[] s_EditAdminUsersByIdSecurityRequirements =
            new global::Forem.EndPointSecurityRequirement[]
            {                s_EditAdminUsersByIdSecurityRequirement0,
            };
        partial void PrepareEditAdminUsersByIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int id,
            global::Forem.PatchAdminUsersRequest request);
        partial void PrepareEditAdminUsersByIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int id,
            global::Forem.PatchAdminUsersRequest request);
        partial void ProcessEditAdminUsersByIdResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task EditAdminUsersByIdAsync(
            int id,
        ...
        {
            await EditAdminUsersByIdAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Forem.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Forem.AutoSDKHttpResponse> EditAdminUsersByIdAsResponseAsync(
            int id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEditAdminUsersByIdArguments(
            ...
            var __authorizations = global::Forem.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EditAdminUsersByIdSecurityRequirements,
                operationName: "EditAdminUsersByIdAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEditAdminUsersByIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Forem.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Forem.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "editAdminUsersById",
                                methodName: "EditAdminUsersByIdAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEditAdminUsersByIdResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task EditAdminUsersByIdAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Forem.PatchAdminUsersRequest
            {
                Name = name,
                Username = username,
                Summary = summary,
