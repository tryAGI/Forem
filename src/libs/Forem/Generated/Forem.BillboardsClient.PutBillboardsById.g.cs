...
namespace Forem
{
    public partial class BillboardsClient
    {
        ...
        private static readonly global::Forem.EndPointSecurityRequirement s_PutBillboardsByIdSecurityRequirement0 =
        ...
        private static readonly global::Forem.EndPointSecurityRequirement[] s_PutBillboardsByIdSecurityRequirements =
            new global::Forem.EndPointSecurityRequirement[]
            {                s_PutBillboardsByIdSecurityRequirement0,
            };
        partial void PreparePutBillboardsByIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int id,
            object request);
        partial void PreparePutBillboardsByIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int id,
            object request);
        partial void ProcessPutBillboardsByIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPutBillboardsByIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> PutBillboardsByIdAsync(
            int id,
        ...
        {
            var __response = await PutBillboardsByIdAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Forem.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Forem.AutoSDKHttpResponse<string>> PutBillboardsByIdAsResponseAsync(
            int id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePutBillboardsByIdArguments(
            ...
            var __authorizations = global::Forem.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PutBillboardsByIdSecurityRequirements,
                operationName: "PutBillboardsByIdAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePutBillboardsByIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Forem.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Forem.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "putBillboardsById",
                                methodName: "PutBillboardsByIdAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPutBillboardsByIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Forem.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPutBillboardsByIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Forem.AutoSDKHttpResponse<string>(
                                        statusCode: __response.StatusCode,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await PutBillboardsByIdAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
