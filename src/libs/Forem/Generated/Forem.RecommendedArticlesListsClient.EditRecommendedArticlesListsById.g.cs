...
namespace Forem
{
    public partial class RecommendedArticlesListsClient
    {
        ...
        private static readonly global::Forem.EndPointSecurityRequirement s_EditRecommendedArticlesListsByIdSecurityRequirement0 =
        ...
        private static readonly global::Forem.EndPointSecurityRequirement[] s_EditRecommendedArticlesListsByIdSecurityRequirements =
            new global::Forem.EndPointSecurityRequirement[]
            {                s_EditRecommendedArticlesListsByIdSecurityRequirement0,
            };
        partial void PrepareEditRecommendedArticlesListsByIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int id,
            global::Forem.PatchRecommendedArticlesListsRequest request);
        partial void PrepareEditRecommendedArticlesListsByIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int id,
            global::Forem.PatchRecommendedArticlesListsRequest request);
        partial void ProcessEditRecommendedArticlesListsByIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEditRecommendedArticlesListsByIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Forem.RecommendedArticlesList> EditRecommendedArticlesListsByIdAsync(
            int id,
        ...
        {
            var __response = await EditRecommendedArticlesListsByIdAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Forem.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Forem.AutoSDKHttpResponse<global::Forem.RecommendedArticlesList>> EditRecommendedArticlesListsByIdAsResponseAsync(
            int id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEditRecommendedArticlesListsByIdArguments(
            ...
            var __authorizations = global::Forem.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EditRecommendedArticlesListsByIdSecurityRequirements,
                operationName: "EditRecommendedArticlesListsByIdAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEditRecommendedArticlesListsByIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Forem.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Forem.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "editRecommendedArticlesListsById",
                                methodName: "EditRecommendedArticlesListsByIdAsync",
                                pathTemplate: "$\"/api/recommended_articles_lists/{id}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEditRecommendedArticlesListsByIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Forem.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEditRecommendedArticlesListsByIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Forem.RecommendedArticlesList> EditRecommendedArticlesListsByIdAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Forem.PatchRecommendedArticlesListsRequest
            {
                Name = name,
            ...
            return await EditRecommendedArticlesListsByIdAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
