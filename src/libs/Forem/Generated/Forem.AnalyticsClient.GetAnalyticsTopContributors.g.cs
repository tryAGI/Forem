...
namespace Forem
{
    public partial class AnalyticsClient
    {
        ...
        private static readonly global::Forem.EndPointSecurityRequirement s_GetAnalyticsTopContributorsSecurityRequirement0 =
        ...
        private static readonly global::Forem.EndPointSecurityRequirement[] s_GetAnalyticsTopContributorsSecurityRequirements =
            new global::Forem.EndPointSecurityRequirement[]
            {                s_GetAnalyticsTopContributorsSecurityRequirement0,
            };
        partial void PrepareGetAnalyticsTopContributorsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? start,
            ref string? end,
            ref int? articleId,
            ref int? organizationId);
        partial void PrepareGetAnalyticsTopContributorsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? articleId,
            int? organizationId);
        partial void ProcessGetAnalyticsTopContributorsResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task GetAnalyticsTopContributorsAsync(
        ...
        {
            await GetAnalyticsTopContributorsAsResponseAsync(
                start: start,
                end: end,
                articleId: articleId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Forem.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Forem.AutoSDKHttpResponse> GetAnalyticsTopContributorsAsResponseAsync(
            string? start = default,
            string? end = default,
            int? articleId = default,
            int? organizationId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAnalyticsTopContributorsArguments(
            ...
            var __authorizations = global::Forem.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAnalyticsTopContributorsSecurityRequirements,
                operationName: "GetAnalyticsTopContributorsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("article_id", articleId?.ToString())
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetAnalyticsTopContributorsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Forem.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Forem.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getAnalyticsTopContributors",
                                methodName: "GetAnalyticsTopContributorsAsync",
                                pathTemplate: "\"/api/analytics/top_contributors\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAnalyticsTopContributorsResponse(
                    httpClient: HttpClient,
