...
namespace Forem
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Forem.EndPointSecurityRequirement s_PutAdminUsersByIdStatusSecurityRequirement0 =
        ...
        private static readonly global::Forem.EndPointSecurityRequirement[] s_PutAdminUsersByIdStatusSecurityRequirements =
            new global::Forem.EndPointSecurityRequirement[]
            {                s_PutAdminUsersByIdStatusSecurityRequirement0,
            };
        partial void PreparePutAdminUsersByIdStatusArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int id,
            global::Forem.PutAdminUsersStatusRequest request);
        partial void PreparePutAdminUsersByIdStatusRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int id,
            global::Forem.PutAdminUsersStatusRequest request);
        partial void ProcessPutAdminUsersByIdStatusResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task PutAdminUsersByIdStatusAsync(
            int id,
        ...
        {
            await PutAdminUsersByIdStatusAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Forem.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Forem.AutoSDKHttpResponse> PutAdminUsersByIdStatusAsResponseAsync(
            int id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePutAdminUsersByIdStatusArguments(
            ...
            var __authorizations = global::Forem.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PutAdminUsersByIdStatusSecurityRequirements,
                operationName: "PutAdminUsersByIdStatusAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePutAdminUsersByIdStatusRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Forem.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Forem.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "putAdminUsersByIdStatus",
                                methodName: "PutAdminUsersByIdStatusAsync",
                                pathTemplate: "$\"/api/admin/users/{id}/status\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPutAdminUsersByIdStatusResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task PutAdminUsersByIdStatusAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Forem.PutAdminUsersStatusRequest
            {
                Status = status,
                Note = note,
            };

            await PutAdminUsersByIdStatusAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
