...
namespace Forem
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Forem.EndPointSecurityRequirement s_PutAdminUsersByIdEmailSecurityRequirement0 =
        ...
        private static readonly global::Forem.EndPointSecurityRequirement[] s_PutAdminUsersByIdEmailSecurityRequirements =
            new global::Forem.EndPointSecurityRequirement[]
            {                s_PutAdminUsersByIdEmailSecurityRequirement0,
            };
        partial void PreparePutAdminUsersByIdEmailArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int id,
            global::Forem.PutAdminUsersEmailRequest request);
        partial void PreparePutAdminUsersByIdEmailRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int id,
            global::Forem.PutAdminUsersEmailRequest request);
        partial void ProcessPutAdminUsersByIdEmailResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task PutAdminUsersByIdEmailAsync(
            int id,
        ...
        {
            await PutAdminUsersByIdEmailAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Forem.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Forem.AutoSDKHttpResponse> PutAdminUsersByIdEmailAsResponseAsync(
            int id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePutAdminUsersByIdEmailArguments(
            ...
            var __authorizations = global::Forem.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PutAdminUsersByIdEmailSecurityRequirements,
                operationName: "PutAdminUsersByIdEmailAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePutAdminUsersByIdEmailRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Forem.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Forem.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "putAdminUsersByIdEmail",
                                methodName: "PutAdminUsersByIdEmailAsync",
                                pathTemplate: "$\"/api/admin/users/{id}/email\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPutAdminUsersByIdEmailResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task PutAdminUsersByIdEmailAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Forem.PutAdminUsersEmailRequest
            {
                Email = email,
            };

            await PutAdminUsersByIdEmailAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
