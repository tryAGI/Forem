...
namespace Forem
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Forem.EndPointSecurityRequirement s_GetAdminUsersByUserIdIdentitiesSecurityRequirement0 =
        ...
        private static readonly global::Forem.EndPointSecurityRequirement[] s_GetAdminUsersByUserIdIdentitiesSecurityRequirements =
            new global::Forem.EndPointSecurityRequirement[]
            {                s_GetAdminUsersByUserIdIdentitiesSecurityRequirement0,
            };
        partial void PrepareGetAdminUsersByUserIdIdentitiesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int userId);
        partial void PrepareGetAdminUsersByUserIdIdentitiesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int userId);
        partial void ProcessGetAdminUsersByUserIdIdentitiesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        /// <summary>
        /// List identities for a user (Admin)<br/>
        ...
        public async global::System.Threading.Tasks.Task GetAdminUsersByUserIdIdentitiesAsync(
            int userId,
            global::Forem.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await GetAdminUsersByUserIdIdentitiesAsResponseAsync(
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Forem.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Forem.AutoSDKHttpResponse> GetAdminUsersByUserIdIdentitiesAsResponseAsync(
            int userId,
            global::Forem.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAdminUsersByUserIdIdentitiesArguments(
            ...
            var __authorizations = global::Forem.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAdminUsersByUserIdIdentitiesSecurityRequirements,
                operationName: "GetAdminUsersByUserIdIdentitiesAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetAdminUsersByUserIdIdentitiesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Forem.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Forem.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getAdminUsersByUserIdIdentities",
                                methodName: "GetAdminUsersByUserIdIdentitiesAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAdminUsersByUserIdIdentitiesResponse(
                    httpClient: HttpClient,
