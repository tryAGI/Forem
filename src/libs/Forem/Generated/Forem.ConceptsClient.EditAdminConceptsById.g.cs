...
namespace Forem
{
    public partial class ConceptsClient
    {
        ...
        private static readonly global::Forem.EndPointSecurityRequirement s_EditAdminConceptsByIdSecurityRequirement0 =
        ...
        private static readonly global::Forem.EndPointSecurityRequirement[] s_EditAdminConceptsByIdSecurityRequirements =
            new global::Forem.EndPointSecurityRequirement[]
            {                s_EditAdminConceptsByIdSecurityRequirement0,
            };
        partial void PrepareEditAdminConceptsByIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int id,
            global::Forem.PatchAdminConceptsRequest request);
        partial void PrepareEditAdminConceptsByIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int id,
            global::Forem.PatchAdminConceptsRequest request);
        partial void ProcessEditAdminConceptsByIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEditAdminConceptsByIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Forem.Concept> EditAdminConceptsByIdAsync(
            int id,
        ...
        {
            var __response = await EditAdminConceptsByIdAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Forem.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Forem.AutoSDKHttpResponse<global::Forem.Concept>> EditAdminConceptsByIdAsResponseAsync(
            int id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEditAdminConceptsByIdArguments(
            ...
            var __authorizations = global::Forem.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EditAdminConceptsByIdSecurityRequirements,
                operationName: "EditAdminConceptsByIdAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEditAdminConceptsByIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Forem.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Forem.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "editAdminConceptsById",
                                methodName: "EditAdminConceptsByIdAsync",
                                pathTemplate: "$\"/api/admin/concepts/{id}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEditAdminConceptsByIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Forem.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEditAdminConceptsByIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Forem.Concept.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Forem.AutoSDKHttpResponse<global::Forem.Concept>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Forem.Concept.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Forem.Concept> EditAdminConceptsByIdAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Forem.PatchAdminConceptsRequest
            {
                Concept = concept,
            };

            return await EditAdminConceptsByIdAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
